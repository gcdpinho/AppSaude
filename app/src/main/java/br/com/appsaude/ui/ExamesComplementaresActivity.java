...
public class ExamesComplementaresActivity extends BackableActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Services.volleyAutoComplete(this, Constants.URL+"getAllExames"+Constants.LANGUAGE, message, createCallbackAutoComplete());
    ...
    private Handler.Callback createCalbackGet() {
        Handler.Callback callback = new Handler.Callback() {
            @Override
            public boolean handleMessage(Message message) {
                if (message.arg1 == 1)
    ...
    private void buttonDiagnostico(){
        ...
        diag.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (flag)
                    Services.getVolley(campos, getApplicationContext(), Constants.URL+"getExames"+Constants.LANGUAGE, createCalbackGet());
                else
                    startDoencas("");
    ...
    private void volleyAutoCompleteSintomas(){
        ...
        String url = "http://web-saude.com/websaude/getAllExames.php";
